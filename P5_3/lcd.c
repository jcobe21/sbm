...
void symbolToLocalBuffer_L1(uint8_t symbol){
	...
	for(i=0; i<12 ; i++){
		...
		buffer[i+indice] = value1;
		buffer[i+128+indice] = value2;
		
	}
	indice = indice + Arial12x12[offset];
}
...
void symbolToLocalBuffer_L2(uint8_t symbol){
	...
	for(i=0; i<12 ; i++){
		...
		buffer[i+indice2] = value1;
		buffer[i+128+indice2] = value2;
		
	}
	indice2 = indice2 + Arial12x12[offset];
}
*/
...
/*
void LCD_writeLine_L2(const char* texto){
